...
void ScenePlaying::sAttack() {
    ...
    sf::FloatRect attackRect(playerTransform.pos.x - 80, playerTransform.pos.y - playerBoundingBox.halfSize.y - 15,
                             playerBoundingBox.size.x + 100,playerBoundingBox.size.y + 30);

    if (!facingRight)
        attackRect.left -= ((playerBoundingBox.size.x - 100.f / 2));
